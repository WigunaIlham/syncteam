...
>
  <div className="w-full max-w-[360px]">
    ...
    <div style={{ textAlign: "center", marginBottom: "28px" }}>
      ...
      <p style={{ margin: 0, fontSize: "14px", color: "var(--c-muted)" }}>
    ...
    >
        ...
        >
          {loading === "google" ? (
            <span
              ...
              style={{ borderColor: "var(--c-border)", borderTopColor: "var(--c-muted)" }}
            />
          ) : (
      ...
      >
        <p style={{ margin: 0, fontSize: "11px", textAlign: "center", color: "var(--c-muted)", lineHeight: 1.6 }}>
    ...
    {/* Footer */}
    <p style={{ textAlign: "center", marginTop: "18px", fontSize: "12px", color: "var(--c-muted)" }}>
      Sudah punya akun?{" "}
      <Link
        href="/login"
